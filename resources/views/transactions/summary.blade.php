...
<div class="tbl-block">
    ...
    <table class="svod-table" id="svod-tbl">
        ...
        @php
            ...
            $barW    = min($pf['pct'], 100);
            $dKey    = 'd_' . md5($dist);
            // Years that have either fact payments or plan schedule entries for this district
            $distYears = array_keys(array_replace(
                array_fill_keys(array_keys($pfYear ?? []), true),
                []
            ));
            $distYears = [];
        ...
        @php
            ...
            // Aggregate year fact totals from dayRows
        ...
        {{-- Day level: pure render, all logic pre-computed in controller --}}
        @foreach($moDayRows as $dr)
